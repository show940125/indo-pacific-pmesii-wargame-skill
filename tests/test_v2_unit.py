...
class V2UnitTests(unittest.TestCase):
    ...
    def test_v3_knowledge_db_seed_and_context_pack(self) -> None:
        ...
        try:
            ...
            self.assertTrue(pack["concrete_actor_context"]["geographic_bases"])
            self.assertTrue(pack["concrete_actor_context"]["base_inventories"])
            self.assertTrue(pack["concrete_actor_context"]["logistics_lanes"])
            self.assertTrue(pack["concrete_actor_context"]["actor_redlines"])
